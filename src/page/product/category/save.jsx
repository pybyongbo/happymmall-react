...
class CategorySave extends React.Component{
    ...
    render(){
        ...
        return (
            <div id="page-wrapper">
                 <PageTitle title="品类列表" gobackTitle="返回" gobackUrl="/product-category/index"/>
                 <div className="row savepage">
                      <div className="col-md-12">
                          <div className="form-horizontal">
                              <div className="form-group">
                                  <label htmlFor="" className="col-md-2 control-label">所属品类</label>
                                  <div className="col-md-5">
                                        <select name="parentId" id="" className="form-control" onChange={onValueChange}> 
                                            <option value="0">跟品类</option>
                                            {categoryOptions}
                                        </select>
                                  </div>
                              </div>
