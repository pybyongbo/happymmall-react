...
class CategorySelector extends React.Component {
    ...
    render() {
        ...
        let firstCategoryList =this.state.firstCategoryList && this.state.firstCategoryList.map((category, index) => {
                return (
                    <option key={index} value={category.id}>{category.name}</option>
                )
            }),
            secondCategoryList = this.state.secondCategoryList && this.state.secondCategoryList.map((category, index) => {
                return (
                    <option key={index} value={category.id}>{category.name}</option>
                )
            }),
        ...
        return (
            ...
            {this.state.secondCategoryList && this.state.secondCategoryList.length > 0 ?
